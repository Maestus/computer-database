...
public abstract class ModelDAO {
	 ...
	 * 
	 * @param model
	 *            Un objet représentant un tuple d'une table.
	 * @throws Exception
	 ...
	 * 
	 * @param m
	 *            un object à mettre à jour dans la base de données.
	 */
	 ...
	 * 
	 * @param connexion
	 *            Objet de connection à la base données.
	 * @param sql
	 *            Chaine de caractere detaillant la requete qui sera executé.
	 * @param returnGeneratedKeys
	 *            Indique si l'on souhaite obtenir la clé de l'objet nouvellement
	 *            crée (par exemple)
	 * @param objets
	 *            Ensemble de variable qui permettent de personnaliser la requete
	 *            sql
